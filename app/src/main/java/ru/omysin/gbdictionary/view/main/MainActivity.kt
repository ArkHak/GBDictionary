...
import ru.omysin.gbdictionary.databinding.ActivityMainBinding
...
import ru.omysin.gbdictionary.view.base.BaseActivity
...
class MainActivity : BaseActivity<AppState>() {
    ...
    private val onListItemClickListener: Adapter.OnListItemClickListener =
        object : Adapter.OnListItemClickListener {
                ...
                if (dataModel == null || dataModel.isEmpty()) {
                    ...
                    if (adapter == null) {
                        ...
                        binding.mainActivityRecyclerview.adapter =
                            Adapter(onListItemClickListener, dataModel)
                    } else {
